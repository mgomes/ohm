...
files and ordinary package boundaries over reflection, naming magic, or runtime
discovery.
...
Keeping generators explicit makes generated code easy to review, test, and
modify. The cost is that Ohm will need careful generator design and snapshot
