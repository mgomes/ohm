...
func TestGenerateReplayTestWritesRegressionTest(t *testing.T) {
	...
	writeReplaySnapshot(t, snapshotPath, replay.Snapshot{
		...
		ExpectedResponse: &replay.ExpectedResponse{
			...
			Body: []byte(`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Journal</title></head><body><main><section id="home"><h1>Welcome to Journal</h1></section></main></body></html>`),
		},
	})
